import { $ as Slice, C as getUpdatedPosition$1, G as PluginKey, H as AllSelection, J as TextSelection, K as Selection, U as NodeSelection, W as Plugin, Z as Fragment, a as MappablePosition, r as Extension } from "./core+[...].mjs";
		...
		const computeDelta = () => {
			while (n !== null) {
				if (isVisible$1(n, snapshot) || prevSnapshot !== void 0 && isVisible$1(n, prevSnapshot)) switch (n.content.constructor) {
					...
					case ContentFormat: if (isVisible$1(n, snapshot)) {
						packStr();
...
var assert = production ? () => {} : (o, schema) => {
	...
	if (!schema.check(o, err)) throw create$2(`Expected value to be of type ${schema.constructor.name}.\n${err.toString()}`);
};
/* c8 ignore end */
/**
* @template In
...
var PatternMatcher = class {
	...
	*/
		...
		return (o, s) => {
			...
			throw create$2("Unhandled pattern");
		};
	}
};
/**
...
//#endregion
//#region node_modules/lib0/hash/sha256.node.js
/**
...
//#endregion
export { ySyncPluginKey as i, absolutePositionToRelativePosition as n, relativePositionToAbsolutePosition as r, isChangeOrigin as t };
