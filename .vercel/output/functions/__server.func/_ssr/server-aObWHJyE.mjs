...
//#region node_modules/.nitro/vite/services/ssr/assets/server-aObWHJyE.js
var server_aObWHJyE_exports = /* @__PURE__ */ __exportAll({
	a: () => getRequest,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CGy3hu95.mjs");
...
var manifest = {
	"58beb3aa1029d1cbea2558f09a40cc2f5534e563a28992562bb8365fbb86c39a": {
		functionName: "searchLeaguesFn_createServerFn_handler",
		importer: () => import("./football-sync.functions-CoUqn6kO.mjs")
	},
	"757588b243131f20b58f28fef7b2cbef0bf2ade367ea4a07661e4977d37472fa": {
		functionName: "syncFixturesFn_createServerFn_handler",
		importer: () => import("./football-sync.functions-CoUqn6kO.mjs")
	},
	"bb8da1886b20fa1fa23ced3458440f21a65e13e3258f39d40ae196827cc8f3b3": {
		functionName: "setLeagueTrackedFn_createServerFn_handler",
		importer: () => import("./football-sync.functions-CoUqn6kO.mjs")
	},
	"c14f41c0675b1e1b96510ffe43f5dd096d906f4286b5a1a3c86af62460fbd09d": {
		functionName: "trackLeagueFn_createServerFn_handler",
		importer: () => import("./football-sync.functions-CoUqn6kO.mjs")
	},
	"d4f5899a6d5d91bef2d1011f72a05c70200c725a4a778f375ac52c545b32827c": {
		functionName: "settleResultsFn_createServerFn_handler",
		importer: () => import("./football-sync.functions-CoUqn6kO.mjs")
	},
	"f5bd06d75bc7fb58bb204399b240d7a0e682961c0d550b5cb50ed08c5385a7d8": {
		functionName: "setMatchResultFn_createServerFn_handler",
		importer: () => import("./football-sync.functions-CoUqn6kO.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C9TCD_gT.mjs").then((n) => n.g).then((n) => n.t),
		import("./start-DJLHI83K.mjs"),
...
//#endregion
export { server_aObWHJyE_exports as a, getServerFnById as i, createServerFn as n, getRequest as r, TSS_SERVER_FUNCTION as t };
